...
function getCarInfoByIndex(inventory,number) {
  const carMake = inventory.find((item, index) => {
    return index === number // we use 2 because index is zero-based.
  })
  return `The car is a ${carMake.car_make} ${carMake.car_model}`
}
